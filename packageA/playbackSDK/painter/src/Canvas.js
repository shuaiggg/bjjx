...
export default class Canvas {
  ...
  constructor(context, width, height, maxHistorySize = 10) {

    const me = this
    me.resize(width, height, true)

    const painter = me.painter = new Painter(context, width, height)

    const emitter = me.emitter = new Emitter()
