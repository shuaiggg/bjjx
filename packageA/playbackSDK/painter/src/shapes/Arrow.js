...
export default class Arrow extends Polygon {
  ...
  drawing(painter, startX, startY, endX, endY, restore) {
    ...
    const { thickness, double } = this

    this.points = Arrow.getPoints(startX, startY, endX, endY, thickness, double)

    this.draw(painter)

  }

  static getPoints(startX, startY, endX, endY, thickness, double) {
